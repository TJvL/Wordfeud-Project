...
public class StatWindow extends JFrame
{
	...
	public void showStats(String highestGameScore, String numGamesPlayed,
			String mostValuableWord, String gamesWon, String competitionsWon)
	{

		
		this.highestGameScore = highestGameScore;
		this.numGamesPlayed = numGamesPlayed;
		this.mostValuableWord = mostValuableWord;
