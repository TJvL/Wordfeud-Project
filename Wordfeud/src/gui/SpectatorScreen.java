...
public class SpectatorScreen extends JPanel
{
	...
	private JList activeGamesList = new JList(listArray);

	//ActiveGamesListCellRenderer myAGLCR = new ActiveGamesListCellRenderer();
